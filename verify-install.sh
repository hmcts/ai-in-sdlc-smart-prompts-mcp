...
echo "   GITHUB_REPO: ${GITHUB_REPO:-ai-in-sdlc-smart-prompts}"
echo ""

# Test GitHub access
echo "3. Testing GitHub access..."
GITHUB_OWNER=${GITHUB_OWNER:-$OWNER} GITHUB_REPO=${GITHUB_REPO:-ai-in-sdlc-smart-prompts} node -e "
...
if [ $? -eq 0 ]; then
    ...
    echo '{'
    echo '  "mcpServers": {'
    echo '    "ai-in-sdlc-smart-prompts": {'
    echo '      "command": "node",'
    echo '      "args": ["'$(pwd)'/dist/index.js"],'
    echo '      "env": {'
    echo '        "GITHUB_OWNER": "hmcts",'
    echo '        "GITHUB_REPO": "ai-in-sdlc-smart-prompts"'
    echo '      }'
    echo '    }'
    echo '  }'
    echo '}'
